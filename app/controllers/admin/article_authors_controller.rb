class Admin::ArticleAuthorsController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @article_author.save
        format.html { redirect_to @article_author, notice: 'Artist was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @article_author.update(article_author_params)
        format.html { redirect_to @article_author, notice: 'Artist was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to article_authors_url, notice: 'Artist was successfully deleted.' }
  ...
  private
    ...
    def article_author_params
    	params.require(:article_author).permit(:admin_id,:content_id)
    end
end
